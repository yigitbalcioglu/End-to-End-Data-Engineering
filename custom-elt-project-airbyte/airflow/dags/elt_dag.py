...
t2 = DockerOperator(
    ...
    mounts=[
        Mount(source='/Users/PC/Desktop/custom-elt-project-airbyte/postgres_transformations',
              target='/dbt', type='bind'),
        Mount(source='/Users/PC/Desktop/custom-elt-project-airbyte/.dbt', target='/root', type='bind'),
    ],
    dag=dag
)
